...
# ------------------------------------------------------------------ #
#  TE (Transformer Engine) CP Attention Benchmark (CPU Timing)         #
...
echo "============================================================"
echo "  TE CP Attention Benchmark (CPU Timing)"
...
torchrun $DISTRIBUTED_ARGS benchmark_te_cp_cpu.py --attn_impl "$ATTN_IMPL" --dtype "$DTYPE"
