...
ncu --set "full" --nvtx --nvtx-include "flashmask/" --kernel-name=regex:$regex_filter  -o fwd_32k_full -f --import-source yes /root/paddlejob/workspace/env_run/xiehaoyang/fm_env_base/bin/python profile_flashmask.py
