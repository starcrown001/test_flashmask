...
export LD_LIBRARY_PATH=/root/paddlejob/workspace/env_run/xiehaoyang/fm_test_env/lib/python3.10/site-packages/nvidia/cu13/lib:$LD_LIBRARY_PATH

ARGS=""
USE_RS=${USE_RS:-0}
source /root/paddlejob/workspace/env_run/xiehaoyang/fm_test_env/bin/activate
if [ $USE_RS -gt 0 ]; then
    PYTHON_BIN="${PYTHON_BIN:-/root/paddlejob/workspace/env_run/xiehaoyang/fm_test_env/bin/python}"
    ARGS="$ARGS --use_rs"
